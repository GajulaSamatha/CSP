  ...
  <div class="form-container">
    ...
    <form action="new_register_cust.php" method="POST" id="registrationForm">
      ...
      <div class="form-group">
        ...
        <input type="tel" id="phoneNumber" name="phoneNumber" value="<?php echo htmlspecialchars($phone ?? ''); ?>" required />
        <?php if (isset($errors['phoneNumber'])): ?>
            <span class="error"><?php echo htmlspecialchars($errors['phoneNumber']); ?></span>
        <?php endif; ?>
      </div>
      ...
      <?php if (isset($errors['geolocation'])): ?>
          <span class="error"><?php echo htmlspecialchars($errors['geolocation']); ?></span>
      <?php endif; ?>
      ...
      <div class="form-group">
        ...
        <?php if (isset($errors['location'])): ?>
            <span class="error"><?php echo htmlspecialchars($errors['location']); ?></span>
        <?php endif; ?>
      </div>
