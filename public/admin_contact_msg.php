...
require_once __DIR__ . '/../src/mysqli_compat.php';
echo urlencode($message['name']); ?>&background=<?php 
require_once __DIR__ . '/../src/mysqli_compat.php';
echo $bg_color; ?>&color=fff" class="user-avatar">
                                            <div>
                                                <div><?php 
require_once __DIR__ . '/../src/mysqli_compat.php';
echo htmlspecialchars($message['name']); ?></div>
                                                <small class="text-muted">User ID: <?php 
require_once __DIR__ . '/../src/mysqli_compat.php';
echo $message['id'] ?? 'N/A'; ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div><?php 
require_once __DIR__ . '/../src/mysqli_compat.php';
echo htmlspecialchars($message['email']); ?></div>
                                    </td>
                                    <td><?php 
require_once __DIR__ . '/../src/mysqli_compat.php';
echo !empty($message['subject']) ? htmlspecialchars($message['subject']) : 'No subject'; ?></td>
                                    <td>
                                        <div class="message-preview" title="<?php 
require_once __DIR__ . '/../src/mysqli_compat.php';
...
echo htmlspecialchars($message['message']); ?>
                                    ...
                                    <td><?php 
require_once __DIR__ . '/../src/mysqli_compat.php';
echo date('M j, Y g:i A', strtotime($message['created_at'])); ?></td>
                                    
                                    </td>
                                    <td>
                                        <button class="action-btn view-btn" title="View Message" data-bs-toggle="modal" data-bs-target="#messageModal" data-message="<?php 
require_once __DIR__ . '/../src/mysqli_compat.php';
echo htmlspecialchars($message['message']); ?>" data-subject="<?php 
require_once __DIR__ . '/../src/mysqli_compat.php';
echo htmlspecialchars($message['subject']); ?>" data-user="<?php 
require_once __DIR__ . '/../src/mysqli_compat.php';
echo htmlspecialchars($message['name']); ?>">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <a href="?delete_id=<?php 
require_once __DIR__ . '/../src/mysqli_compat.php';
echo $message['id']; ?>" class="action-btn delete-btn" title="Delete Message" onclick="return confirm('Are you sure you want to delete this message?');">
