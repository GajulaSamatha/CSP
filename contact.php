            ...
            <div class="row">
                ...
                <div class="col-lg-8 mb-4">
                    <div class="contact-form fade-in">
                        ...
                        <form id="contactForm" method="POST" action="contact_submit.php" novalidate>
                            <div class="row">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="message" name="message" rows="5" required placeholder="Tell us more about your inquiry..."></textarea>
                                <div class="invalid-feedback">Please provide a message (minimum 10 characters).</div>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="contact-info slide-in">
                        ...
                        <div class="contact-item">
                            ...
                            <div>
                                <h5>Email</h5>
                                <p class="mb-0">support@nandyalservices.com</p>
                        ...
                        <div class="contact-item">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Mon-Sat, 9AM-7PM IST</small>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.getElementById('contactForm').addEventListener('submit', function(e) {
            ...
            if (message.value.trim().length < 10) {
                ...
                message.nextElementSibling.textContent = 'Please provide a message (minimum 10 characters).';
                isValid = false;
            } else {
        ...
        document.querySelectorAll('.contact-item, .contact-form, .map-placeholder').forEach(el => {
            el.style.opacity = '0';
